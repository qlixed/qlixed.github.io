...
BLOG_AUTHOR = "QLiXed [aka Ezequiel Brizuela]"  # (translatable)
BLOG_TITLE = "qlixed.github.io"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://qlixed.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://qlixed.github.io/"
BLOG_EMAIL = "qlixed@gmail.com"
BLOG_DESCRIPTION = "This is a demo to check the autopublish option of nikola"  # (translatable)
